...
<!-- Mirrored from decomagna.amosbilly.co.ke/v3/{{url('/')}} by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 Jun 2023 09:45:19 GMT -->
<head>
    <meta charset="UTF-8" />
  ...
  -->
    ...
    - google font link
  -->
    <link rel="preconnect" href="../../fonts.googleapis.com/{{url('/')}}" />
    <link rel="preconnect" href="../../fonts.gstatic.com/{{url('/')}}" crossorigin />
    <link
      ...
      <div class="container">
        ...
        <nav class="navbar" data-navbar>
          <ul class="navbar-list">
            ...
            <li>
              <a href="{{url('/')}}/products" class="navbar-link" data-nav-link
                >Our products</a
              >
            </li>
...
<!-- Mirrored from decomagna.amosbilly.co.ke/v3/{{url('/')}} by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 Jun 2023 09:46:07 GMT -->
</html>
